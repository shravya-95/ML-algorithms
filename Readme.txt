Author: Krishna Shravya Gade
Date: 02.17.2020

How to run:
1.Make sure latest sci-kit version is installed using pip3
2.Place all the 3 folders in the current working directory of python 3
3.Run the main file using the below commands:
	Q3 i) python3 q3i.py
	Q3 ii) python3 q3ii.py
	Q4 iii) python3 q4.py

We will be considering three datasets (derived from two available datasets) for these assignments:
...
a 2-class classification problem such that y = 1 if r ≥ τ50 and y = 0 if r < τ50. 
ii. Boston75: Let τ75 be the 75th percentile over all r (response) values. Create a 2-class
classification problem such that y = 1 if r ≥ τ75 and y = 0 if r < τ75. 
